...
try:
    ...
    class ParametricUMAP:
        """Dummy ParametricUMAP class that raises ImportError when Tensorflow is not installed.

        This class is created when Tensorflow is not available to provide a helpful error
        message to users attempting to use ParametricUMAP functionality.
        """
